...
export default function LegislationManager() {
  ...
  const loadCategoriesHierarchy = async () => {
    try {
      ...
      console.log('🎯 Categories hierarchy loaded:', response);
  ...
  const getSelectedCategoryNames = (): string => {
    if (selectedCategories.length === 0) return 'TODAS AS CATEGORIAS LEGAIS';
    if (selectedCategories.length === 1) {
      ...
      return findCategoryName(selectedCategories[0], categoriesHierarchy) || 'CATEGORIA';
    }
    return `${selectedCategories.length} CATEGORIAS LEGAIS`;
  };
          ...
          <CardContent className="p-3">
            <div className="space-y-3">
              ...
              <Button
                ...
                variant="outline"
                className="justify-between font-police-body font-medium uppercase tracking-wider transition-all duration-300 border border-gray-300 dark:border-gray-600 hover:border-accent-500 hover:text-accent-500 dark:hover:border-accent-500 px-4 py-2 h-auto"
              >
          ...
          >
            ...
            >
              ...
              <div className="relative mb-4">
                ...
                <input
                  type="text"
                  placeholder="Buscar categorias legais..."
                ...
                {loadingCategories ? (
                  ...
                  <div className="text-center py-8 text-gray-500">
                    ...
                    <p className="font-police-body text-sm">
                      NENHUMA CATEGORIA LEGAL DISPONÍVEL
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="flex justify-between items-center mt-4">
                <div className="text-sm text-gray-600 dark:text-gray-400 font-police-body">
                  ...
                  {selectedCategories.length} CATEGORIA(S) LEGAL(IS)
                </div>
