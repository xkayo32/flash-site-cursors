                            ...
                            <CardContent className="space-y-3">
                              ...
                              <div>
                                ...
                                <Button
                                  onClick={() => setShowCategoryModal(true)}
                                  variant="outline"
                                  className="w-full justify-between font-police-body font-medium uppercase tracking-wider transition-all duration-300 border border-primary-200 dark:border-gray-600 hover:border-accent-500 hover:text-accent-500 dark:hover:border-accent-500 px-3 py-2 text-sm"
                                >
                                  <span className="truncate">{getSelectedCategoryNames()}</span>
                                  <Filter className="w-4 h-4 ml-2 flex-shrink-0" />
                                </Button>
          ...
          >
            ...
            >
              ...
              <div className="relative mb-4">
                ...
                <input
                  type="text"
                  placeholder="Buscar categorias intel..."
                ...
                {loadingCategories ? (
                  ...
                  <div className="text-center py-8 text-gray-500">
                    ...
                    <p className="font-police-body text-sm">
                      NENHUMA CATEGORIA INTEL DISPONÍVEL
                    </p>
                  </div>
                )}
              </div>
              ...
              <div className="flex justify-between items-center mt-4">
                <div className="text-sm text-gray-600 dark:text-gray-400 font-police-body">
                  ...
                  {selectedCategories.length} CATEGORIA(S) INTEL
                </div>
