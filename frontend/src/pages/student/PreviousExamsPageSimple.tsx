...
const previousExams: PreviousExam[] = [
  ...
  {
    id: 3,
    title: 'OPERAÇÃO PC SP - ESCRIVÃO 2023',
          ...
          >
            ...
            <div className="p-6">
              ...
              <div className="space-y-2 mb-6">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-xs font-police-subtitle uppercase tracking-ultra-wide text-gray-600 dark:text-accent-500">BANCA:</span>
                  <span className="text-sm font-police-body text-gray-900 dark:text-white">{exam.examBoard}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-xs font-police-subtitle uppercase tracking-ultra-wide text-gray-600 dark:text-accent-500">ANO:</span>
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 bg-accent-500 hover:bg-accent-600 dark:hover:bg-accent-650 text-black font-police-body font-semibold uppercase tracking-wider py-2 px-4 rounded-lg transition-all duration-300 hover:scale-105"
                >
                  EXECUTAR OPERAÇÃO
                </button>
                <button
                  onClick={() => navigate(`/previous-exams/${exam.id}/view`)}
                  className="bg-gray-200 dark:bg-gray-800 hover:bg-gray-300 dark:hover:bg-gray-700 text-gray-900 dark:text-white font-police-body font-semibold uppercase tracking-wider py-2 px-3 rounded-lg transition-all duration-300 hover:scale-105"
                >
                  ANALISAR
                </button>
              </div>
      ...
      {filteredExams.length === 0 && (
        <div className="text-center py-12">
          <div className="bg-white dark:bg-gray-900 border-2 border-gray-200 dark:border-gray-800 rounded-lg p-8">
            <p className="text-gray-600 dark:text-gray-400 font-police-body uppercase tracking-wider">NENHUMA OPERAÇÃO LOCALIZADA</p>
          </div>
        </div>
      )}
    </div>
