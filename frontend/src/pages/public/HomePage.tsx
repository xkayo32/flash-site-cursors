    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-white font-police-primary" style={{ scrollBehavior: 'smooth' }}>
            ...
            <div className="flex items-center gap-4">
              ...
              <Link to="/checkout?plan=price_monthly_premium">
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="hidden md:flex items-center gap-2 px-4 md:px-6 py-2 md:py-3 bg-accent-500 hover:bg-accent-600 text-black font-police-subtitle rounded transition-all duration-300 text-xs md:text-sm tracking-widest-plus btn-gradient-overlay shadow-lg hover:shadow-xl"
                >
            ...
            <nav className="flex flex-col p-4 space-y-2">
              ...
              <div className="flex flex-col gap-2 pt-4 border-t border-gray-200 dark:border-gray-700">
                ...
                <Link to="/checkout?plan=price_monthly_premium" onClick={() => setMobileMenuOpen(false)}>
                  <button className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-accent-500 hover:bg-accent-600 text-black font-police-subtitle rounded transition-all duration-300 text-sm tracking-widest-plus shadow-lg hover:shadow-xl">
                    <Trophy className="w-4 h-4" />
                    GARANTIR APROVAÇÃO
                  </button>
                </Link>
      ...
      <section className="relative bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white py-12 md:py-24 overflow-hidden min-h-[90vh] md:min-h-screen flex items-center">
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-white/50 dark:from-black/50 via-white/70 dark:via-black/70 to-white dark:to-black"></div>
            ...
            >
              <Link to="/checkout?plan=price_monthly_premium">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="group flex items-center gap-2 md:gap-3 bg-accent-500 hover:bg-accent-600 text-black text-lg md:text-xl font-police-title px-8 md:px-10 py-4 md:py-5 rounded-md shadow-2xl transition-all duration-300 tracking-widest md:tracking-widest-plus btn-gradient-overlay justify-center min-h-[56px] touch-manipulation"
                >
      ...
      <section id="courses" className="relative py-12 md:py-20 bg-gray-100 dark:bg-gray-900">
        ...
        >
          <div className="absolute inset-0 bg-gray-100/95 dark:bg-gray-900/95"></div>
          <div className="absolute inset-0 bg-gradient-to-b from-gray-100 dark:from-gray-900 via-gray-100/90 dark:via-gray-900/90 to-gray-100 dark:to-gray-900"></div>
        </div>
              ...
              <motion.div key={index} variants={fadeInUp}>
                <Card className={`relative h-full ${plan.popular ? 'ring-2 ring-accent-500 shadow-2xl scale-105 bg-accent-500 text-black' : 'bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-military-base dark:text-white'}`}>
                  ...
                  <CardContent className="p-8 text-center">
                    ...
                    <Button
                      className={`w-full py-4 text-lg font-police-title tracking-widest-plus btn-gradient-overlay shadow-lg hover:shadow-xl ${
                        plan.popular 
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <motion.div variants={fadeInUp}>
              <Link to="/checkout?plan=price_monthly_premium">
                <Button className="bg-accent-500 hover:bg-accent-600 text-black text-lg md:text-xl font-police-title px-10 md:px-12 py-5 md:py-6 rounded-md tracking-widest md:tracking-widest-plus btn-gradient-overlay min-h-[60px] touch-manipulation shadow-lg hover:shadow-xl">
                  GARANTIR APROVAÇÃO
      ...
      <motion.a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-4 md:bottom-6 right-4 md:right-6 z-50 bg-accent-500 hover:bg-accent-600 text-black p-4 md:p-5 rounded-full shadow-2xl transition-all duration-300 hover:scale-110 touch-manipulation"
        initial={{ scale: 0 }}
        animate={{ scale: 1 }}
