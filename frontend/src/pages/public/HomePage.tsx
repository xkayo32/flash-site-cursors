  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-white font-police-primary" style={{ scrollBehavior: 'smooth' }}>
                    ...
                    <Button
                      className={`w-full py-4 text-lg font-police-title tracking-widest-plus shadow-lg hover:shadow-xl ${
                        plan.popular 
                          ...
                          : 'bg-gray-900 dark:bg-gray-100 hover:bg-gray-800 dark:hover:bg-accent-650 text-white dark:text-black hover:text-white dark:hover:text-white'
                      }`}
                    >
                      {plan.cta}
                    </Button>
      ...
      <motion.a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-4 md:bottom-6 right-4 md:right-6 z-50 bg-gray-900 dark:bg-gray-100 hover:bg-gray-800 dark:hover:bg-accent-650 text-white dark:text-black hover:text-white dark:hover:text-white p-4 md:p-5 rounded-full shadow-2xl transition-all duration-300 hover:scale-110 touch-manipulation"
        initial={{ scale: 0 }}
        animate={{ scale: 1 }}
