...
export function Logo({ 
    ...
    >
      <defs>
        <linearGradient id="gradient1" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" style={{ stopColor: '#14242f', stopOpacity: 1 }} />
          <stop offset="100%" style={{ stopColor: '#1e3a4c', stopOpacity: 1 }} />
        </linearGradient>
      ...
      <path d="M14 18 L22 18 M14 21 L22 21 M14 24 L22 24 M14 27 L20 27" 
            stroke="#14242f" strokeWidth="1.5" strokeLinecap="round"/>
  ...
  const LogoFull = () => (
    ...
    >
      ...
      <g>
        <circle cx="24" cy="24" r="22" fill="url(#logoGradient1)" filter="url(#logoShadow)"/>
      ...
      <g>
        <text x="56" y="30" fontFamily="Arial, sans-serif" fontSize="28" fontWeight="bold" fill="url(#textGradient)">
          Study
        </text>
        <text x="120" y="30" fontFamily="Arial, sans-serif" fontSize="28" fontWeight="bold" fill="url(#logoGradient2)">
          Pro
        </text>
        
        <text x="56" y="42" fontFamily="Arial, sans-serif" fontSize="10" fill="#6b7280" opacity="0.8">
