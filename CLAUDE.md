...
### **2025-01-16**: Sistema de Compatibilidade Anki e Melhorias de UX
- **Sistema robusto de importação Anki com detecção de versão**
- **AnkiVersionHelper para compatibilidade entre versões 2.0, 2.1, 2.3+**
- **Fallback automático para formatos JSON alternativos**
- **Funcionalidade de excluir deck implementada para estudantes**
- **Correção crítica no FlashcardStudyModal**
- **Suporte para múltiplos formatos de importação (Anki JSON, AnkiConnect)**
- **Documentação completa de versões suportadas (ANKI_VERSION_SUPPORT.md)**
- **Organização de scripts de teste em estrutura apropriada**

### **2025-01-29**: Modais de Confirmação Customizados
- **Substituição completa de window.confirm por modais customizados**
- **Modal diferenciado para decks (vermelho) e flashcards (amarelo)**
- **Preview do conteúdo do flashcard antes de deletar**
- **Atualização imediata da lista sem recarregar página**
- **Atualização de estatísticas em tempo real**
- **Design consistente com tema militar/tático**
- **Melhor experiência de usuário com feedback visual imediato**
