...
import usersRoutes from './routes/users-postgres.routes';
import categoriesRoutes from './routes/categories-postgres.routes';
import dashboardRoutes from './routes/dashboard.routes';
import questionsRoutes from './routes/questions.routes';
import flashcardsRoutes from './routes/flashcards';
import flashcardDecksRoutes from './routes/flashcard-decks-postgres';
